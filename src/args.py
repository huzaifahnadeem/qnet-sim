...
def get_args():
    ...
    parser.add_argument('--prob_swap_loss', required=False, default=config.prob_swap_loss, type=float, help=f'The probability that a pair of qubits would be lost when a swap operation is performed. Its the 1-\'q\' parameter.') # TODO: eventually this will be removes and instead a noise model will be added to the PhysicalInstruction objects for the swap operation
    ...
    # phases delay:
    parser.add_argument('--p1_delay', required=False, default=config.p1_delay, type=int, help=f'The time delay before signalling the end of phase 1.')
    parser.add_argument('--p2_delay', required=False, default=config.p2_delay, type=int, help=f'The time delay before signalling the end of phase 2. p2 also has a timeout delay (--link_establish_timeout). Overall delay in p2 is --p2_delay + --link_establish_timeout')
    parser.add_argument('--p3_delay', required=False, default=config.p3_delay, type=int, help=f'The time delay before signalling the end of phase 3.')
    parser.add_argument('--p4_delay', required=False, default=config.p4_delay, type=int, help=f'The time delay before signalling the end of phase 4.')
